<x-guest-layout>
    {{-- 1. SCRIPT GOOGLE RECAPTCHA (Wajib ada) --}}
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        {{-- 
            🔥 2. POSISI KOTAK RECAPTCHA 🔥 
            Ditaruh di sini: Setelah "Remember Me" dan sebelum Tombol "Masuk".
        --}}
        <div class="mt-6">
            <div class="g-recaptcha" data-sitekey="{{ env('RECAPTCHA_SITE_KEY') }}"></div>
            
            {{-- Pesan Error jika lupa mencentang --}}
