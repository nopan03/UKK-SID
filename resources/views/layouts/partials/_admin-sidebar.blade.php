<aside
    class="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-green-800 border-r dark:bg-green-900 dark:border-gray-700">
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav>
            ...
            <a class="flex items-center px-4 py-2 mt-5 text-gray-200 rounded-md hover:bg-green-700 hover:text-white 
                ...
                <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M16.5 4V2M7.5 4V2" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            {{-- Link untuk Manajemen Keuangan --}}
            <a class="flex items-center px-4 py-2 mt-5 text-gray-200 rounded-md hover:bg-green-700 hover:text-white 
        {{ request()->routeIs('admin.keuangan.*') ? 'bg-green-700 text-white' : '' }}"
                href="{{ route('admin.keuangan.index') }}">
                {{-- Ikon SVG untuk Keuangan/Dompet --}}
                <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M17 8H7C5.89543 8 5 8.89543 5 10V18C5 19.1046 5.89543 20 7 20H17C18.1046 20 19 19.1046 19 18V10C19 8.89543 18.1046 8 17 8Z"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M13 8V6C13 4.89543 12.1046 4 11 4H9C7.89543 4 7 4.89543 7 6V8" stroke="currentColor"
                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M16 14H14" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                </svg>
                <span class="mx-4 font-medium">Manajemen Keuangan</span>
            </a>
        </nav>
    </div>
</aside>
