<div class="space-y-6">
    ...
    {{-- Keperluan --}}
    <div>
        <label class="block text-sm font-medium text-gray-700 mb-1">Keperluan Pembuatan SKCK <span class="text-red-500">*</span></label>
        <textarea name="keperluan" rows="3" required placeholder="Contoh: Melamar Pekerjaan di BUMN / Pendaftaran TNI"
            class="w-full border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500">{{ old('keperluan') }}</textarea>
    </div>
    ...
    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200 space-y-4">
        ...
        {{-- Akta Kelahiran --}}
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Foto Akta Kelahiran <span class="text-red-500">*</span></label>
        ...
        {{-- Pengantar RT --}}
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Surat Pengantar RT/RW <span class="text-red-500">*</span></label>
            <input type="file" name="file_pengantar" required accept=".jpg,.jpeg,.png,.pdf" 
                class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 border border-gray-300 rounded-lg">
        </div>
    </div>
</div>