            ...
            <div class="md:pl-44">
                ...
                <div class="max-w-4xl mx-auto md:mx-0 bg-white p-8 md:p-12 rounded-lg shadow-lg">
                    ...
                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                        ...
                        <h2 class="mt-8 mb-4 text-primary-yellow text-2xl font-bold">Sejarah Dusun Suruh</h2>
                        
                        <img src="{{ asset('img\Suruh.jpeg') }}" alt="Ilustrasi Dusun Suruh" class="rounded-lg mb-6 w-full object-cover h-64 md:h-80 shadow-md">
                        ...
                        <h2 class="mt-12 mb-4 text-primary-yellow text-2xl font-bold">Sejarah Dusun Prumpon</h2>
                        
                        {{-- 
                           🔥 PERBAIKAN:
                           1. 'object-bottom': Memaksa gambar fokus ke bagian bawah (agar kain putih terlihat).
                           2. 'md:h-[500px]': Menambah tinggi khusus foto ini agar tidak terlalu terpotong (karena fotonya potrait/tinggi).
                        --}}
                        <img src="{{ asset('img\Prumpon.jpeg') }}" 
                             alt="Ilustrasi Dusun Prumpon" 
                             class="rounded-lg mb-6 mt-6 w-full object-cover object-bottom h-80 md:h-[500px] shadow-md">
                        ...
                        <h2 class="mt-12 mb-4 text-primary-yellow text-2xl font-bold">Sejarah Dusun Lengki</h2>
                        
                        <img src="{{ asset('img\Lengki.jpeg') }}" alt="Ilustrasi Dusun Lengki" class="rounded-lg mb-6 mt-6 w-full object-cover h-64 md:h-80 shadow-md">
