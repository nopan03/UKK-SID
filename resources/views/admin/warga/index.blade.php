...
<div class="container mx-auto px-4 py-6">
    ...
    {{-- ALERT WARNING (INFO DATA IKUT TERHAPUS) --}}
    @if(session('warning'))
                        ...
                        <tr class="bg-white border-b hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex item-center justify-center space-x-2">
                                    ...
                                    {{-- Tombol Hapus --}}
                                    <form action="{{ route('admin.warga.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data warga ini? Semua akun dan riwayat surat terkait juga akan dihapus permanen.');">
                                        @csrf
                                        @method('DELETE')
