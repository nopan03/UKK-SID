...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500">Perbarui informasi berita: <span class="font-bold text-green-700">{{ $berita->judul }}</span></p>
    </div>
            ...
            <form method="POST" action="{{ route('admin.berita.update', $berita->id) }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="judul" name="judul" value="{{ old('judul', $berita->judul) }}" required autofocus
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="kategori" name="kategori" class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring focus:ring-green-200 transition duration-200">
                                ...
                                <option value="Potensi Desa" {{ old('kategori', $berita->kategori) == 'Potensi Desa' ? 'selected' : '' }}>Potensi Desa</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="date" id="tanggal" name="tanggal" value="{{ old('tanggal', $berita->tanggal ?? date('Y-m-d')) }}" required
                                class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring focus:ring-green-200 transition duration-200">
                    ...
                    <div>
                        ...
                        @if($berita->gambar)
                            <div class="mb-3">
                                ...
                                <img src="{{ asset('storage/' . $berita->gambar) }}" alt="Thumbnail Lama" class="h-32 w-auto rounded border border-gray-200 object-cover">
                            </div>
                        @endif
                        ...
                        <p class="mt-1 text-xs text-gray-500">Kosongkan jika tidak ingin mengganti gambar. Format: JPG, PNG. Maksimal 2MB.</p>
                    ...
                    <div>
                        ...
                        <textarea id="isi" name="isi" rows="10" required
                            class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring focus:ring-green-200 transition duration-200">{{ old('isi', $berita->isi) }}</textarea>
