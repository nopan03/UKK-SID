                ...
                <div class="p-6 md:p-8 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('admin.berita.update', $berita->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="kategori" class="block mt-1 w-full" type="text" name="kategori" :value="old('kategori', $berita->kategori)" required />
                            ...
                            {{-- Upload Gambar --}}
                            <div>
                                <x-input-label for="gambar" :value="__('Ganti Gambar Utama (Opsional)')" />
                                @if($berita->gambar)
                                    <img src="{{ asset('storage/berita-images/' . $berita->gambar) }}" alt="Gambar saat ini" class="w-48 h-auto rounded mb-2">
                                @endif
                                <input id="gambar" class="block mt-1 w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50" type="file" name="gambar">
                            ...
                            <div>
                                ...
                                <textarea id="isi" name="isi" rows="10" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm">{{ old('isi', $berita->isi) }}</textarea>
                        ...
                        <div class="flex items-center justify-end mt-6">
                            ...
                            <x-primary-button>{{ __('Perbarui Berita') }}</x-primary-button>
                        </div>
                    </form>
                </div>
            </div>
